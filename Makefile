...
DB_PASSWORD=test1
DB_PORT=5432
DB_CONTAINER=test1-postgres
REDIS_PORT=6379
REDIS_CONTAINER=test1-redis
...
help: ## Show this help message
	@echo "🚀 test1 Development Commands"
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
build-inner:
	...
	GOCACHE=$$(pwd)/.go-cache GOMODCACHE=$$(pwd)/.go-mod-cache go build -o bin/test1 cmd/server/main.go
...
score-build: ## Build Docker images for Score.dev
	...
	@docker build -t test1/backend:latest .
...
score-up: ## Start full-stack app using Score.dev + Docker Compose
	@echo "🚀 Starting test1 with Score.dev..."
	@make score-build
	@make score-generate
	@docker compose up -d
	@echo ""
